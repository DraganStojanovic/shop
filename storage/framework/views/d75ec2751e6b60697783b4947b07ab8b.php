        ...
        <div class="px-4 py-5 my-5 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a class="btn btn-primary btn-lg px-4" href="<?php echo e(url('/shop-page')); ?>" role="button">Get back to Shop</a>
        ...
        <div class="container py-4 pb-5">
            ...
            <form method="POST" action="<?php echo e(route('product.save', ['id' => $product->id ])); ?>" id="contactForm" enctype="multipart/form-data">
                ...
                <div class="col-md-6 offset-md-3 p-3">
                    ...
                    <input class="form-control" id="emailAddress" name="name" placeholder="Name of product" value="<?php echo e($product->name); ?>" />
                </div>
                <!-- Name input -->
                <div class="col-md-6 offset-md-3 p-3">
                    <label class="form-label" for="description">Description</label>
                    <textarea class="form-control" id="description" name="description" placeholder="Description" style="height: 10rem; "><?php echo e($product->description); ?></textarea>
                </div>
                <!-- Name input -->
                <div class="col-md-6 offset-md-3 p-3">
                    <label class="form-label" for="amount">Amount</label>
                    <input class="form-control" id="amount" name="amount" type="text" placeholder="Amount" value="<?php echo e($product->amount); ?>"/>
                </div>
                <!-- Message input -->
                <div class="col-md-6 offset-md-3 p-3">
                    <label class="form-label" for="price">Price</label>
                    <input class="form-control" id="price" name="price" type="text" placeholder="Price" value="<?php echo e($product->price); ?>"/>
                </div>
                <!-- Message input -->
                <div class="col-md-6 offset-md-3 p-3">
                    <label for="formFileLg" class="form-label">Insert image of Product</label>
                    <input class="form-control form-control-lg" id="formFileLg" name="image" type="file" placeholder="Insert image of Product" value="<?php echo e($product->image); ?>">
                </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop\resources\views/edit-product.blade.php ENDPATH**/ ?>