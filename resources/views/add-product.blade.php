        ...
        <div class="px-4 py-5 my-5 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a class="btn btn-primary btn-lg px-4" href="{{ url('/shop') }}" role="button">Get back to Shop</a>
                    <a class="btn btn-info btn-lg px-4" href="{{ url('/about') }}" role="button">About Us</a>
                </div>
            </div>
        </div>
        ...
        <div class="container py-4 pb-5">
            ...
            <form method="POST" action="{{ route('saveProduct') }}" id="contactForm" enctype="multipart/form-data">
                ...
                <div class="col-md-6 offset-md-3 p-3">
                    ...
                    <input class="form-control" id="emailAddress" name="name" placeholder="Name of product" value="{{ old('name') }}" />
                </div>
                <!-- Name input -->
                <div class="col-md-6 offset-md-3 p-3">
                    <label class="form-label" for="description">Description</label>
                    <textarea class="form-control" id="description" name="description" placeholder="Description" style="height: 10rem; " value="{{ old("description") }}"></textarea>
                </div>
                <!-- Name input -->
                <div class="col-md-6 offset-md-3 p-3">
                ...
                <div class="col-md-6 offset-md-3 p-3">
                    ...
                    <input class="form-control form-control-lg" id="formFileLg" name="image" type="file" placeholder="Insert image of Product" value="{{ old("image") }}">
                </div>
